<%@ page language="VB" autoeventwireup="false" inherits="Inventory_TransferOutDocument, App_Web_transferoutdocument.aspx.9758fd70" maintainscrollpositiononpostback="true" theme="Classic" enableEventValidation="false" %>
                    ...
                    <table class="paramlist admintable" cellspacing="1" width="100%">
                        <tr>
                            ...
                            <td class="paramlist_key">
                                <asp:Label ID="lb6" runat="server" Style="display: none;">Invoice Ref.</asp:Label>
                                <asp:Label ID="lb8" runat="server">Delivery Date</asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtInvoice1" runat="server" Width="220px" Style="display: none;"></asp:TextBox>
                        ...
                        <tr>
                            <td class="paramlist_key">
                                ...
                                <asp:Label ID="lbDept" runat="server">Depatment</asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlToInv" runat="server" Width="220px" Style="display: none;">
                                </asp:DropDownList>
                                <asp:DropDownList ID="ddlDepatment" runat="server" Width="220px">
                                </asp:DropDownList>
                            </td>
                            <td class="paramlist_key">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="RdoDocs_DdlYear" runat="server" Height="22px">
                                </asp:DropDownList>
