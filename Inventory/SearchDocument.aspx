<%@ page language="VB" autoeventwireup="false" inherits="Inventory_SearchDocument, App_Web_searchdocument.aspx.9758fd70" enableEventValidation="false" %>
                ...
                <div class="jpane-slider">
                    <table class="paramlist admintable" cellspacing="1" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="paramlist_key">
                                <asp:Label ID="lb6" runat="server">VendorGroup</asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="paramlist_key">
                                <asp:Label ID="lb7" runat="server">Vendor</asp:Label>
                            </td>
                            <td>
