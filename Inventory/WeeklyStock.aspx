<%@ page language="C#" autoeventwireup="true" inherits="Inventory_WeeklyStock, App_Web_weeklystock.aspx.9758fd70" enableEventValidation="false" %>
                    ...
                    success: function(data) {
                        ...
                        if (data.approve == '1') {
                            ...
                            alertDialog(function() {
                                window.location = "WeeklyStock.aspx?StaffID=" + require_var.staffId + '&StaffRoleID=' + require_var.staffRole +
        ...
        function cancelStockCount() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    alertDialog(function() {
                        window.location = "WeeklyStock.aspx?StaffID=" + require_var.staffId + '&LangID=' + require_var.langId + '&StaffRoleID=' + require_var.staffRole;
                    });
