<%@ page language="VB" autoeventwireup="false" inherits="SettingWebConfig, App_Web_settingwebconfig.aspx.cdcab7d2" enableEventValidation="false" %>
...
<body>
    ...
    <div style="width: 550px; margin: 30px;">
        <fieldset>
            ...
            <fieldset>
                <legend>Connection Database</legend>
                <table class="adminlist" cellspacing="1">
                    <tr>
                        <td align="right" width="150px">
                            <asp:Label ID="LbDBName" runat="server" Text="Database Name"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="LbDBServer" runat="server" Text="Server Name"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="LbDBShopID" runat="server" Text="InventoryName"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="DdlDBShopID" runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
            ...
            <fieldset>
                <legend>FTP For Load File Count Stock.</legend>
                <table class="adminlist" cellspacing="1">
                    <tr>
                        <td align="right" width="150px">
                            <asp:Label ID="LBFTPServer" runat="server" Text="FTP Server"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="TxtFTPServer" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="150px">
                            <asp:Label ID="LbFTPUserName" runat="server" Text="UserName"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="TxtFTPUserName" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="LbFTPPassword" runat="server" Text="Password"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="TxtFTPPassword" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="LbFTPPathSend" runat="server" Text="Folder Send"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="TxtFTPPathSend" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="LbFTPPathRecv" runat="server" Text="Folder Recv"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="TxtFTPPathRecv" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="LbFileUploadName" runat="server" Text=" Upload FileName"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="TxtFileUploadName" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="LbFileDownloadName" runat="server" Text="Download FileName"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="TxtFileDownloadName" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="LbPathFileCountStock" runat="server" Text="Local Path"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="TxtPathFileCountStock" runat="server" Width="250px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="LbHasFTP" runat="server" Text="FTP Option"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="TxtHasFTP" runat="server"></asp:TextBox> <span>1= Get File From FTP.,0= Get File From Local.</span>
                        </td>
                    </tr>
                </table>
            </fieldset>
            <div style="text-align:center;">
                <asp:Button ID="BtnSave" runat="server" Text="Save Config" />
                <asp:Button ID="BtnCancel" runat="server" Text="Back To Main Page" /></div>
        </fieldset>
    </div>
    </form>
</body>
