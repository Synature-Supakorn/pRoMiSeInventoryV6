<%@ page language="C#" autoeventwireup="true" inherits="Inventory_DailyStock, App_Web_dailystock.aspx.9758fd70" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function displayMaterial() {
            ...
            url: 'DataXML/DailyStockDataXML.aspx?action=load&StaffID=' + require_var.staffId + '&langId=' + require_var.langId + '&invId=' + $('#<%=ddlInv.ClientID %> :selected').val() + '&allowCount=' + allowCount }).trigger('reloadGrid');
                        ...
                        if (data.sess_timeout && data.sess_timeout == 1) {
                            ...
                            if (data.approve == '1') {
                                ...
                                alertDialog(function() {
                                    window.location = "DailyStock.aspx?StaffID=" + require_var.staffId + '&StaffRoleID=' + require_var.staffRole +
        ...
        function cancelStockCount() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    alertDialog(function() {
                        window.location = "DailyStock.aspx?StaffID=" + require_var.staffId + '&LangID=' + require_var.langId + '&StaffRoleID=' + require_var.staffRole;
                    });
...
<body onkeypress="return DisableEnterKey(event);">
    ...
    <div>
        <div class="ui-widget ui-widget-header" style="height: 30px; padding: 4px 10px;">
            <div style="float: left; font-size: 14px;">
                ...
                <div style="float: left;">
                    <div style="margin: 2px 0 0 2px;">
                        <asp:Label ID="lbl_1_1" runat="server" Text="นับสต๊อกรายวัน"></asp:Label></div>
                    <div style="height: 4px; font-size: 11px; font-weight: lighter;">
                        <asp:Label ID="lbl_1_2" runat="server" Text="นับสต๊อกเมื่อสิ้นสุดในแต่ละวัน เพื่อปรับจำนวนสต๊อกให้ถูกต้อง"></asp:Label></div>
                </div>
            </div>
            ...
            <script type="text/javascript">
                ...
                $("#btnPrintForm").button({
                   ...
                   //print_daily = window.open('Report/CrStockCountDaily.aspx?invName=' +
                   // $('#ddlInv :selected').text() +
                   // '&stockCountName=<%=lbl_1_1.Text %>' + '&countType=dailystockmaterial' +
        ...
        <div style="margin: 8px 4px">
            ...
            <div  style="margin:0 auto; text-align:center;"><asp:Label ID="lblMonthCount" runat="server"></asp:Label></div>
                        ...
                        gridComplete: function() {
                            ...
                            if (ids.length > 0) {
                                ...
                                "#txtCountUnitName", "#btnCountMat", "#btnApprove", "#btnSaveForm", "#btnCancelCountStock", "#btnAutoTransferStock");
                                    ...
                                    // enable btn print history only document status is approved
