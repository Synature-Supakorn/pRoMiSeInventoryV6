<%@ page language="VB" autoeventwireup="false" inherits="Inventory_ReceiveFromTransfer, App_Web_receivefromtransfer.aspx.9758fd70" maintainscrollpositiononpostback="true" theme="Classic" enableEventValidation="false" %>

<%@ Register TagPrefix="uc1" TagName="MenuBar" Src="~/UserControl/Menu.ascx" %>
<%@ Register Src="../UserControl/Footer.ascx" TagName="Footer" TagPrefix="uc2" %>
<html>
<head runat="server">
    <title>Receive From Tranfer Document.</title>
        ...
        <div id="content-pane" class="pane-sliders">
            <div class="panel">
                <h3 id="detail-page" class="title jpane-toggler">
                    ...
                    <asp:Label ID="lb5" runat="server" style="display:none;"></asp:Label>
                    <asp:Label ID="lbDocumentRef" runat="server"></asp:Label>
                </h3>
