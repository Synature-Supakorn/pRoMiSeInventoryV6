<%@ page language="VB" autoeventwireup="false" inherits="Inventory_PrefinishDocument, App_Web_prefinishdocument.aspx.9758fd70" maintainscrollpositiononpostback="true" theme="Classic" enableEventValidation="false" %>

<%@ Register TagPrefix="uc1" TagName="MenuBar" Src="~/UserControl/Menu.ascx" %>
<%@ Register Src="../UserControl/Footer.ascx" TagName="Footer" TagPrefix="uc2" %>
<html>
<head runat="server">
    <title>PrefinishDocument</title>
...
<body>
    ...
    <div id="toolbar-button">
        ...
        <div class="toolbar-title">
            <asp:Label ID="lt" runat="server" CssClass="texttitle">Prefinish Document</asp:Label></div>
